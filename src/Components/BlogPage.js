...
import { GetPublishedLogItem } from "../Services/DataService";
...
export default function BlogPage() {
  ...
  useEffect(() => {
    const fetchDta = async () => {
      let res = await GetPublishedLogItem();
      setBlogItems(res);
    };
  ...
  //    Image: "https://www.almanac.com/sites/default/files/styles/landscape/public/image_nodes/tomatoes_helios4eos_gettyimages-edit.jpeg?itok=m9c3T-XV",
  //    Published: true,
  ...
  //    Image: "https://www.farmersalmanac.com/wp-content/uploads/2020/11/Planting-Guide-Bell-Peppers-A105431708.jpg",
  //    Published: false,
  //    Tags: "hot,plant",
  //    Category: "Pastas"
  //   }, {
  ...
  //    Image: "https://cleangreensimple.com/wp-content/uploads/2020/05/growing-eggplant.jpg",
  //    Published: true,
  //    Tags: "gardening,plant",
  //    Category: "Sports"
  //   }, {
  ...
  //    Image: "https://greenhouseemporium.com/wp-content/uploads/2020/02/How_to_Grow_Zucchini_2.jpg",
  //    Published: false,
  //    Tags: "gardening,plant",
  //    Category: "Cats"
  //   },
